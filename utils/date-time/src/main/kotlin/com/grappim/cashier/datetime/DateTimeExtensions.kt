package com.grappim.cashier.datetime
...
fun String.getOffsetDateTimeFromString(inUtc: Boolean = false): OffsetDateTime = OffsetDateTime
    .parse(this)
...
fun String.getZonedDateTime(inUtc: Boolean = false): ZonedDateTime = ZonedDateTime.parse(this)
