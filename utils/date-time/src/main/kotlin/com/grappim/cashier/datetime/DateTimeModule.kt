...
object DateTimeModule {
    ...
    fun provideIsoInstant(): DateTimeFormatter = DateTimeFormatter.ISO_INSTANT

    @[Provides DateTimeIsoLocalDateTime]
    fun provideIsoLocalDateTime(): DateTimeFormatter = DateTimeFormatter.ISO_LOCAL_DATE_TIME
}
