...
class SignUpFragment : BaseFragment<SignUpViewModel>() {
    ...
    private fun SignUpFragmentScreen() {
        ...
        val status by viewModel.signUpStatus.observeAsState(initial = com.grappim.common.lce.Try.Initial)
        val validationData by viewModel.signUpValidation.observeAsState(initial = null)

        LoaderDialogCompose(show = status is com.grappim.common.lce.Try.Loading)
