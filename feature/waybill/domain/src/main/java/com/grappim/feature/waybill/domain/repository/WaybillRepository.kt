...
interface WaybillRepository {
    ...
    fun getProducts(params: GetWaybillProductsParams): Flow<PagingData<WaybillProduct>>

    suspend fun createWaybillProduct(params: CreateWaybillProductParams): Try<BigDecimal, Throwable>

    suspend fun getWaybillProductByBarcode(
        params: GetWaybillProductByBarcodeParams
    ): Try<WaybillProduct, Throwable>

    suspend fun updateWaybillProduct(params: UpdateWaybillProductParams): Try<BigDecimal, Throwable>

    suspend fun conductWaybill(params: ConductWaybillParams): Try<Unit, Throwable>

    suspend fun rollbackWaybill(params: RollbackWaybillParams): VoidTry<Throwable>
}
