...
class AddProductToBasketUseCase @Inject constructor(private val bagRepository: BagRepository) {

    suspend fun execute(params: AddProductToBasketParams): Try<BasketProduct, Throwable> =
