...
class GetBagProductsUseCase @Inject constructor(private val bagRepository: BagRepository) {

    suspend fun execute(): Try<List<BasketProduct>, Throwable> = bagRepository.getBasketProducts()
}
