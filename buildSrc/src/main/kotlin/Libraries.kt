...
object Deps {
    ...
    object AndroidX {
        ...
        const val hiltNavigation = "androidx.hilt:hilt-navigation-fragment:${Versions.AndroidX.hiltAndroidX}"
    }
    ...
    object Compose{
        ...
        const val runtimeLivedata= "androidx.compose.runtime:runtime-livedata:${Versions.AndroidX.Compose.core}"
        const val foundation= "androidx.compose.foundation:foundation:${Versions.AndroidX.Compose.core}"
        const val foundationLayout= "androidx.compose.foundation:foundation-layout:${Versions.AndroidX.Compose.core}"
        const val icons= "androidx.compose.material:material-icons-extended:${Versions.AndroidX.Compose.core}"

        const val lifecycleViewModel = "androidx.lifecycle:lifecycle-viewmodel-compose:${Versions.AndroidX.Compose.lifecycle}"
        const val paging = "androidx.paging:paging-compose:${Versions.AndroidX.Compose.paging}"
        const val constraint = "androidx.constraintlayout:constraintlayout-compose:${Versions.AndroidX.Compose.constraint}"
        const val hiltNavigation = "androidx.hilt:hilt-navigation-compose:${Versions.AndroidX.Compose.hiltNavigation}"
        const val navigation = "androidx.navigation:navigation-compose:${Versions.AndroidX.Compose.navigation}"
    }
    ...
    object Google {
        ...
        const val hiltAndroidCompiler = "com.google.dagger:hilt-android-compiler:${Versions.Google.hilt}"
    ...
    const val debugDb = "com.github.amitshekhariitbhu.Android-Debug-Database:debug-db:${Versions.debugDb}"
    ...
    const val recyclerViewAnimators = "jp.wasabeef:recyclerview-animators:${Versions.recyclerAnimators}"
