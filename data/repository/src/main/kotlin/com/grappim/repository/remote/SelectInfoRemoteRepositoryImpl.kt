...
class SelectInfoRemoteRepositoryImpl @Inject constructor(
    ...
    override suspend fun saveCashBox(params: SaveCashBoxParams) = applicationScope.launch {
        generalStorage.setCashBoxInfo(params.cashBox)
    }.join()

    override suspend fun saveStock(params: SaveStockParams) = applicationScope.launch {
    ...
    override suspend fun getCashBoxes(): Try<List<CashBox>, Throwable> = runOperationCatching {
